...
$$
\left\lbrace \begin{array}{l} \theta = \arctan \left( \frac{ \sum_{i=0}^{7} L_i \cdot \sin(\theta_{L_i}) }{ \sum_{i=0}^{7} L_i \cdot \cos(\theta_{L_i}) } \right) \begin{cases} \rho = \left\lbrace \begin{array}{l l} 0 \begin{cases} \text{Light}_{\text{max}} & \text{if GroundMem = 1 and fFire = 1} \end{array} \right. \end{array} \right..
$$
...
$$
\left\lbrace \begin{array}{l} \theta = \pi - \arctan \left(\frac {\sum_ {i = 0} ^ {7} L _ {i} \cdot \sin \left(\theta_ {L _ {i}}\right)}{\sum_ {i = 0} ^ {7} L _ {i} \cdot \cos \left(\theta_ {L _ {i}}\right)}\right) \begin{cases} \rho = \left\lbrace \begin{array}{l l} 0 & \begin{cases} 1 - \text{Light}_{\text{max}} & \text{if GroundMem = 1 and fFire = 1} \end{array} \right. \end{array} \right.
$$
...
$$
\left\lbrace \begin{array}{l} \theta = \arctan \left(\frac {\sum_ {i = 0} ^ {7} L _ {iBlue} \cdot \sin \left(\theta_ {L _ {i}}\right)}{\sum_ {i = 0} ^ {7} L _ {iBlue} \cdot \cos \left(\theta_ {L _ {i}}\right)}\right) \begin{cases} \rho = \left\lbrace \begin{array}{l l} 0 & \begin{cases} \text{LightBlue}_{\text{max}} & \text{if fFire = 0 and fExtinguisher = 1} \end{array} \right. \end{array} \right.
$$
...
$$
\left\lbrace \begin{array}{l} \theta = \arctan \left( \frac{ \sum_{i=0}^{7} L_{iRed} \cdot \sin(\theta_{L_i}) }{ \sum_{i=0}^{7} L_{iRed} \cdot \cos(\theta_{L_i}) } \right) \begin{cases} \rho = \left\lbrace \begin{array}{l l} 0 \begin{cases} LightRed_{max}  & \text{if } fFire = 0 \text{ and } fExtinguisher = 0 \end{array} \right. \end{array} \right.
$$
...
$$
\left\lbrace \begin{array}{l} \theta = \pi - \arctan \left( \frac{ \sum_{i=0}^{7} L_{iRed} \cdot \sin(\theta_{L_i}) }{ \sum_{i=0}^{7} L_{iRed} \cdot \cos(\theta_{L_i}) } \right) \begin{cases} \rho = \left\lbrace \begin{array}{l l} 0  & \text{if } LightRed_{max} < FIRE - THRESHOLD + 0.01 \begin{cases} 1 & \text{if } LightRed_{max} \geq FIRE - THRESHOLD + 0.01 \end{array} \right. \end{array} \right.
$$
...
$$
\left\lbrace \begin{array}{l} \theta = \pi - \arctan \left(\frac {\sum_ {i = 0} ^ {7} I R _ {i} \cdot \sin \left(\theta_ {L _ {i}}\right)}{\sum_ {i = 0} ^ {7} I R _ {i} \cdot \cos \left(\theta_ {L _ {i}}\right)}\right) \begin{cases} \rho = \left\lbrace \begin{array}{l l} 0 & \text{if } I R _ {max}  <   \text{PROXIMITY} - \text{THRESHOLD} \begin{cases} 1 & \text{if } I R _ {max} \geq \text{PROXIMITY} - \text{THRESHOLD} \end{array} \right. \end{array} \right.
$$
